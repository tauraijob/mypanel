        ...
        <table class="w-full">
          <thead class="bg-slate-800/50">
            <tr>
              ...
              <th class="text-left text-xs font-semibold text-slate-400 uppercase px-4 py-3"></th>
            </tr>
          </thead>
        ...
        <div class="p-6 bg-slate-900">
          ...
          <template v-if="selectedPayment">
            ...
            <div class="text-center mb-6">
              <p class="text-sm text-slate-400 mb-1">Amount Paid</p>
            ...
            <div class="space-y-4">
              ...
              <div v-if="selectedPayment.transactionId" class="flex justify-between py-3 border-b border-white/10">
                ...
                <span class="text-white font-mono text-sm">{{ selectedPayment.transactionId.slice(0, 30) }}{{ selectedPayment.transactionId.length > 30 ? '...' : '' }}</span>
              </div>
